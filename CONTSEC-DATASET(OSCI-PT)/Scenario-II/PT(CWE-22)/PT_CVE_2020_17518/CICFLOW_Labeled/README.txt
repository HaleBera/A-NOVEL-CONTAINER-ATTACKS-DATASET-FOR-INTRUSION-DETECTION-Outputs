...
- Aynı CVE-ID (CVE_2020_17518) 'ye sahip 3 atağın rastgele ardışık(serial) olacak şekilde birer kez arda düzenlendiği senaryonun (Scenario-II) testlerinin 4 ayrı çalıştırmasının sonucunda elde eilen Flow dosyalarını içermektedir.
